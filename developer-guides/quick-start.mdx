...
If you're the admin of your team, [get API key of the target project](/developer-guides/quick-start#manage-project-api-keys) on the admin console.
...
If you're a team member, simply ask your admin to provide you with one.
