...
4. Choose a data source type, configure the data source, and click **Finish**. Alternatively, you can directly click **Skip and Finish** to create an empty data source, which is not recommended. 
...
You can skip this step to directly use Powerdrill to start inquiries on public information. However, we recommend that you import your data so that you can have tailored experience of certain Powerdrill features that mainly differentiate Powerdrill from general chatboxes.



## Step 3: Extract intelligence from your data

After configuring the dataset, you can start use the associated App to start exploring intelligence from your data.
...
* [Dataset as ChatGPT Plugin]: publishes your datasets as ChatGPT plugins to interact with the OpenAI ecosystem.
