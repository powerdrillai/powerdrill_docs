...
<Tip>
  The files you upload (images and audio files are not included) will be permanently stored in your datasets and consume your storage space credits. You can manage then on the **Datasets** page.
</Tip>
