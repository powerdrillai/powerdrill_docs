...
4. Choose a data source type, configure the data source, and click **Finish**. Alternatively, you can directly click **Skip and Finish** to create an empty dataset. You can import data sources later.
...
You can skip this step and jump to [Step 3](#step-3-extract-intelligence-from-your-data) to directly use Powerdrill to start inquiries with ChatGPT. However, we recommend that you import your data so that you can have tailored experience of certain Powerdrill features  against your data that mainly differentiate Powerdrill from general chatboxes.
