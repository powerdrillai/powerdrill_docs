...
You can skip this step and jump to [Step 3](#step-3-extract-intelligence-from-your-data) to directly use Powerdrill to start inquiries based on public information. However, we recommend that you import your data so that you can have tailored experience of certain Powerdrill features that mainly differentiate Powerdrill from general chatboxes.
