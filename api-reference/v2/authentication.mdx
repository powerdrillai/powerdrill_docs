...
- **Team API keys**: provide access to manage projects, such as creating new projects. Only the team admin account can manage projects.
    ...
    <Tip>
     Since project-related API endpoints are still under development, team API keys are currently non-functional. As the team admin, you can [manage your projects](/enterprise/projects#manage-your-projects) through the admin console instead.
    </Tip>
