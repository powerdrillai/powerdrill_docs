---
openapi: post /v1/team/file/upload-datasource
...
<CodeGroup>
```curl cURL
curl --location 'http://ai.data.cloud/api/v1/team/file/upload_datasource' \
...
url = "http://ai.data.cloud/api/v1/team/file/upload_datasource"
