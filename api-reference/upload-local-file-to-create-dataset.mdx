---
title: "Upload Local Files to Create Data Sources"
...
This guide explains how to upload a local file to create a data source. 
...
In this example, the data source is in the `synced` state and is ready for use in data analysis jobs.
