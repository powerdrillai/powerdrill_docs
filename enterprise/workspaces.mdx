...
One account can only be the owner of up to one team. This means, you can create a team only when these is no team is owned by your account.

However, you can be regular users in multiple teams as long as you accept others' invitations.
