...
* Change the validity period of your shared datasets based on your needs.
...
For more information about how to log in to Powerdrill and create a dataset, see Steps 1 and 2 in [Try Out Powerdrill in 3 Minutes](/quick-start#step-1-sign-in-to-powerdrill).
...
1. On the **Datasets** page, find the dataset you want to share, click the share button in the **Actions** column.
2. In the **Invite** dialog box, change the validity period based on your needs.
3. Repeat Step 3 in section [Share a dataset](/features/dataset-sharing#share-a-dataset).
...
<iframe width="724" height="400" src="https://www.youtube.com/watch?v=z_DPB7A1Jg8" title="Dataset sharing - https://powerdrill.ai" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>