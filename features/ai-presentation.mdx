...
The new feature **AI Presentation Maker**, which generates clear, organized slide decks based on the files you upload. Key benefits include:
...
- **Multi-language support**: English is the default output language. You can select the target 
...
2. From the left sidebar, choose **Presentations**. You will be directed to a page similar to this:
    ...
    <Frame>
      <img src="/images/new-prens.png" style={{ borderRadius: '0.5rem' }} />
    </Frame>
...
4. Now, all you need to do is waiting for the complete. This process takes just one or two minutes.
