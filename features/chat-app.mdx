...
You have logged in to Powerdrill and created a dataset with Simple Apps associated. For more information about how to log in to Powerdrill and create a dataset, see Steps 1 and 2 in [Try Out Powerdrill in 3 Minutes].
