...
The Terms of Service ("**Terms**" or "**Terms of Service**") determine the rules of the Service (as defined in the following section) and explain the legal relationship between you and Brightskai ("**Brightskai**", "**POWERDRILL**", "**Company**", "**we**", "**our**", or "**us**"). The Company operates web pages that are located at [powerdrill.ai](https://powerdrill.ai/) ("**Website**") and provides the Service. We offer the Service to help professional entities with their business. To use the Service or register an account, you must declare that:
